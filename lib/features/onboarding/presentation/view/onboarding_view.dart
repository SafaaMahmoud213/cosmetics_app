...
import 'package:cosmetics_app/features/onboarding/presentation/widgets/costom_container_small.dart';
import 'package:cosmetics_app/features/onboarding/presentation/widgets/costom_contsiner_long.dart';
import 'package:cosmetics_app/features/onboarding/presentation/widgets/costom_floating_button.dart';
                ...
                if (currentIndex != 2)
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        NavigateTo().pushAndRemoveUntil(page: SignInView());
                      },
                      child: const Text(
                        "Skip",
                        style: TextStyle(
