...
import 'package:cosmetics_app/feature/auth/presentation/views/verify_code_view.dart';
import 'package:cosmetics_app/feature/auth/presentation/widgets/costom_header.dart';
            ...
            CostomButton(
              onTap: () {
                if (formkey.currentState!.validate()) {
                  AppNavigator().push(page: VerifyCodeView());
                }
              },
